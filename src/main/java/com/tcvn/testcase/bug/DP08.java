...
public class DP08 extends CoreTestTemplate {

	@Test(groups = "KVTestcase")
	public void test_DP08() throws Exception {
		...
		System.out.println("Show alert message: "+drivingPage.getAlertMsg());
		drivingPage.clickAlertOK();
		loginPage.clearDriverID();
		loginPage.inputDriverID("033333");
		...
		//Running to stop 4
		stopPage = new StopPageObject(driver);
		boolean stopView = stopPage.isOpenStopView();
		assertTrue(stopView);
	}
}