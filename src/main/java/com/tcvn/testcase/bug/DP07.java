...
public class DP07 extends CoreTestTemplate {

	@Test(groups = "KVTestcase")
	public void test_DP07() throws Exception {
		System.out.println("Start DP07");
		//Login to DP
		...
		//Let the bus to visit Stop4, input unknown students, swiping card for some students
		assertTrue(stopPage.isOpenStopView());
